...
function bootstrap() {
  return { entity:{ id:'cli_klop', name:'KLOP PROPERTIES LTD' }, accounts, vatCodes, salesInvoices, purchaseBills, bankLines, journals:ledger(), manualJournals:journals, dashboard:dashboard(), vatFeed:vatFeed() };
}
